...
import com.ylesb.plm.http.api.LoginApi;
import com.ylesb.plm.http.glide.GlideApp;
import com.ylesb.plm.http.model.HttpData;
import com.ylesb.plm.manager.InputTextManager;
import com.ylesb.plm.other.KeyboardWatcher;
import com.ylesb.plm.ui.fragment.MineFragment;
import com.ylesb.plm.wxapi.WXEntryActivity;
import com.hjq.http.EasyConfig;
import com.hjq.http.EasyHttp;
import com.hjq.http.listener.HttpCallback;
import com.ylesb.umeng.Platform;
import com.ylesb.umeng.UmengClient;
import com.ylesb.umeng.UmengLogin;
import com.ylesb.widget.view.SubmitButton;
...
public final class LoginActivity extends AppActivity
    ...
    public void onClick(View view) {
        ...
        if (view == mCommitView) {
            if (mPhoneView.getText().toString().length() == 0) {
